...
/* /namespace.html.twig */
class __TwigTemplate_edc01bb1e5454130726372d5cd414604482ed76ac3cc00ac995a81121392e176 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("base.html.twig", "/namespace.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        $this->loadTemplate("breadcrumbs.html.twig", "/namespace.html.twig", 4)->display($context);
        // line 5
        echo "
    ...
    ";
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "functions", [], "any", false, false, false, 66))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["function"]) {
                // line 70
                echo "                ";
                $this->loadTemplate("function.html.twig", "/namespace.html.twig", 70)->display($context);
                // line 71
                echo "            ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
