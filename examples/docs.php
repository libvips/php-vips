 ...
 * @method static Image pdfload_buffer( $buffer, array $options = []) Load pdf with libpoppler.
 * @method static Image svgload(string $filename, array $options = []) Load svg with rsvg.
 * @method static Image svgload_buffer( $buffer, array $options = []) Load svg with rsvg.
 * @method static Image gifload(string $filename, array $options = []) Load gif with giflib.
 * @method static Image gifload_buffer( $buffer, array $options = []) Load gif with giflib.
 * @method static Image pngload(string $filename, array $options = []) Load png from file.
 * @method static Image pngload_buffer( $buffer, array $options = []) Load png from buffer.
 ...
 * @method static Image jpegload_buffer( $buffer, array $options = []) Load jpeg from buffer.
 * @method static Image webpload(string $filename, array $options = []) Load webp from file.
 * @method static Image webpload_buffer( $buffer, array $options = []) Load webp from buffer.
 * @method static Image tiffload(string $filename, array $options = []) Load tiff from file.
 * @method static Image tiffload_buffer( $buffer, array $options = []) Load tiff from buffer.
 ...
 * @method static Image magickload_buffer( $buffer, array $options = []) Load buffer with imagemagick7.
